...
# usage R -f lsm-position.R --args <lsm-interaction-file> <geneAnnotation-file> <positionAnalysis-dir>
# e.g. R -f lsm-position.R --args <interaction-regions-genes.gff3> <Hsalinarum-annot-genesWithInteraction.gff3 positionAnalysisGenes
...
svg(paste0(positionanalysisgenesdir, "/heatmap.svg"), width = 10, height = 60)
heatmap.2(MM,
          scale="none",
          trace = "none",
          key = FALSE,
...
write.table(genesWithLsmAntiSense, paste0(positionanalysisgenesdir, "/genesWithLsmAntiSense.txt"), sep = " ",
            row.names = FALSE, col.names = FALSE, quote = FALSE)
